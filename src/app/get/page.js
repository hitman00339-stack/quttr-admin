            ...
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <div className="relative h-full flex items-center justify-center">
                <div className="text-center">
                  <div className="qr-gold-red-gradient text-[120px] md:text-[200px] font-black tracking-tight leading-none">15</div>
            ...
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <div className="relative h-full flex items-center justify-center p-8">
                <div className="grid grid-cols-2 gap-4 w-full">
                  {[{ name: 'राज', rating: '4.9' },{ name: 'अमित', rating: '4.8' },{ name: 'विकास', rating: '4.9' },{ name: 'सुनील', rating: '4.7' }].map((b, i) => (
                    <div key={i} className="aspect-square bg-gradient-to-br from-white/[0.08] to-white/[0.02] rounded-2xl border border-white/10 hover:border-[#FFD700]/50 transition-all flex flex-col items-center justify-center p-4">
                      <div className="w-14 h-14 bg-gradient-to-br from-[#E63946]/50 to-[#B01824]/50 rounded-full mb-3 flex items-center justify-center border-2 border-[#FFD700]/30">
                        <span className="qr-hindi text-white font-black text-lg">{b.name[0]}</span>
                      </div>
                      <div className="qr-hindi text-[14px] font-bold text-white/90">{b.name}</div>
                      <div className="text-[11px] text-[#FFD700] mt-1 font-bold">★ {b.rating}</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className={`transition-all duration-1000 delay-200 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <div className="relative h-full flex flex-col justify-center items-center p-8">
                ...
                <div className="qr-gold-red-gradient text-[80px] md:text-[140px] font-black tracking-tight leading-none">8</div>
  ...
  return (
    <section ref={ref} className="min-h-screen flex items-center px-4 py-24 md:py-32 border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
          <div className={`md:order-2 transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="qr-hindi text-[12px] md:text-[13px] font-black tracking-[0.25em] text-[#FFD700] uppercase mb-6">🎁 रिवॉर्ड्स · REWARDS</p>
          ...
          <div className={`md:order-1 transition-all duration-1000 delay-200 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <div className="relative h-full flex flex-col justify-center items-center p-8">
                ...
                <div className="qr-gold-red-gradient text-[70px] md:text-[130px] font-black tracking-tight leading-none">2,450</div>
              </div>
            </div>
          </div>
        </div>
...
function HowItWorks() {
  ...
  return (
    <section ref={ref} className="px-4 py-24 md:py-32 border-t border-white/[0.06]">
      <div className="max-w-7xl mx-auto">
        <div className={`text-center mb-20 transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <p className="qr-hindi text-[12px] md:text-[13px] font-black tracking-[0.25em] text-[#FFD700] uppercase mb-6">कैसे काम करता है</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {steps.map((step, i) => (
            <div key={i} className={`relative transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: `${i * 150}ms` }}>
              <div className="qr-gold-red-gradient text-[80px] md:text-[130px] font-black tracking-tight leading-none opacity-40 mb-4">{step.num}</div>
              <h3 className="qr-hindi text-[28px] md:text-[38px] font-black tracking-tight mb-2 text-white">{step.hi}</h3>
              <p className="text-[15px] font-bold text-[#FFD700] mb-3">{step.en}</p>
              <p className="qr-hindi text-[16px] text-white/70 leading-relaxed">{step.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <div key={i} className={`bg-gradient-to-br from-white/[0.05] to-white/[0.01] border border-white/[0.1] rounded-2xl p-8 transition-all duration-1000 hover:border-[#FFD700]/50 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: `${i * 100}ms` }}>
              ...
              <p className="qr-hindi text-[17px] leading-relaxed text-white/90 mb-6 font-semibold">"{t.quote}"</p>
...
function BarberSection({ onDownload }) {
  ...
  const benefits = [
    ...
    { hi: 'बिज़नेस एनालिटिक्स', en: 'Business analytics' },
          ...
          <div className="flex flex-col items-center mb-12">
            <div className="relative w-24 h-24 md:w-32 md:h-32 mb-6 qr-logo-float">
              ...
              <div className="relative w-full h-full flex items-center justify-center rounded-3xl bg-gradient-to-br from-[#1A237E] to-[#0D1440] border-2 border-[#FFD700]/30">
                <img src="/quttr-business-logo.png" alt="Quttr Business" className="w-full h-full object-contain absolute inset-0" onError={(e) => { e.target.style.display = 'none'; e.target.nextElementSibling.style.display = 'flex'; }} />
    ...
    <footer className="px-4 py-16 border-t border-white/[0.06] bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12 text-[13px] font-semibold">
          ...
          <a href="tel:+919519953149" className="text-white/60 hover:text-[#FFD700] transition-colors">+91 9519953149</a>
    ...
    <style jsx global>{`
      * { -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; }
      ...
      @keyframes qr-progress {
        0% { width: 25%; } 50% { width: 75%; } 100% { width: 25%; }
      }
