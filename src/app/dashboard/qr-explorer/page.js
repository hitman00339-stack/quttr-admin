        ...
        {loading ? (
          ...
          <>
                  ...
                  {data.rows.map((r) => (
                    <tr key={r._id} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition">
                      ...
                      <td className="px-4 py-3 text-center">
                        <Link
                          href={`/dashboard/qr-print/${r.qr_code}`}
                          className="inline-flex p-1.5 rounded-lg bg-[#FFD700]/10 hover:bg-[#FFD700]/25 border border-[#FFD700]/30 transition"
                          title="Print poster"
                        >
            ...
            <div className="lg:hidden divide-y divide-white/[0.05]">
              {data.rows.map((r) => (
                <div key={r._id} className="p-4 hover:bg-white/[0.02]">
                  ...
                  <div className="flex items-center justify-between text-[10px] text-white/40 mt-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link
                        href={`/dashboard/qr-print/${r.qr_code}`}
                        className="inline-flex items-center gap-1 px-2 py-1 rounded bg-[#FFD700]/10 border border-[#FFD700]/30 text-[#FFD700] font-bold text-[10px]"
                      >
