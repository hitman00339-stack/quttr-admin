    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#E63946] to-[#B01824] text-white rounded-lg font-semibold hover:shadow-lg transition"
        >
              ...
              <div key={a._id} className="p-4 hover:bg-white/[0.02] transition flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-1 text-xs text-white/50 flex-wrap">
                    ...
                    {a.city_assigned && <span className="flex items-center gap-1"><MapPin className="w-3 h-3" />{a.city_assigned}</span>}
                  </div>
                </div>
...
function CreateAgentModal({ onClose, onCreated }) {
  const [form, setForm] = useState({
    name: '', phone: '', email: '', password: '', city_assigned: '', notes: '',
  });
